...
Olhando os intervalos de confiança para cada variável, já podemos excluir da análise variáveis que tem valores que cruzam o 0. Isto quer dizer que o valor estimado da mesma não é confiável, não é interessante para nossa análise, visto que pode ter valor igual a 0.Desta forma, sobre `samerace`,`int_corr`,`diferenca_idade` podemos concluir que elas não possuem valor que explica `likes`. Não podemos afirmar que essas variáveis expliquem nossa variável dependente.
